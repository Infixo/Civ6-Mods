...
('BELIEF_CITY_PATRON_GODDESS', 'CITY_PATRON_GODDESS_DISTRICT_PRODUCTION2');
/*

this one is working - extra prod is given
...
*/
/* ADJUST_BUILDING_PRODUCTION

this one is not working - no extra prod is given
...
--ADJUST_BUILDING_PRODUCTION - in percentage
-- - used by Limes, Monarchy, etc.


-- +2 Production flat -  SUCCESS - scored as 46 no matter if building is built or not
--ADJUST_CITY_PRODUCTION_BUILDING - used by Industrial CSs MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PRODUCTION_CHANGE
