...
UPDATE PseudoYields SET DefaultValue = 275 WHERE PseudoYieldType = 'PSEUDOYIELD_CITY_DEFENSES'; -- 	200 - very important for aggression mgmt!
...
UPDATE PseudoYields SET DefaultValue = 4.0 WHERE PseudoYieldType = 'PSEUDOYIELD_IMPROVEMENT'; -- 	0.5 => 3.0 in NFP, 13.5 too much
...
--UPDATE PseudoYields SET DefaultValue = 1.5 WHERE PseudoYieldType = 'PSEUDOYIELD_RESOURCE_LUXURY'; -- 1.5 210616 a new one
...
UPDATE PseudoYields SET DefaultValue = 0.5 WHERE PseudoYieldType = 'PSEUDOYIELD_WONDER'; -- 2, AI+ 0.55
...
-- units
UPDATE PseudoYields SET DefaultValue =  3.5 WHERE PseudoYieldType = 'PSEUDOYIELD_UNIT_AIR_COMBAT'; -- 	2 => 3 in NFP, 2.2 in AI+, 20 in AirpowerFix
...
--UPDATE PseudoYields SET DefaultValue =  1.1 WHERE PseudoYieldType = 'PSEUDOYIELD_UNIT_SETTLER'; -- 1 -- 1.4 seems to much, they build Settlers even with 0 army and undeveloped cities; 210616 back to original - AI settles well
...
UPDATE AiFavoredItems SET Value = 25 WHERE ListType = 'CultureVictoryPseudoYields' AND Item LIKE 'PSEUDOYIELD_GREATWORK_%'; -- def. 10
...
('CultureVictoryPseudoYields', 'PSEUDOYIELD_WONDER', 1, 40), -- base 0.8
...
UPDATE AiFavoredItems SET Value = 50 WHERE ListType = 'ReligiousVictoryPseudoYields' AND Item = 'PSEUDOYIELD_GPP_PROPHET'; -- def. 25
...
('MilitaryVictoryPseudoYields', 'PSEUDOYIELD_GPP_SCIENTIST', 1, 15), -- base 0.7
...
('MilitaryVictoryPseudoYields', 'PSEUDOYIELD_GPP_GENERAL', 1, 15), -- base 0.6
...
INSERT OR REPLACE INTO Types (Type, Kind) VALUES
('STRATEGY_ANCIENT_CHANGES',     'KIND_VICTORY_STRATEGY'), -- 210626 added in NFP
...
INSERT INTO StrategyConditions (StrategyType, ConditionFunction, StringValue, ThresholdValue) VALUES
('STRATEGY_ATOMIC_CHANGES',      'Is Ancient',     NULL, 0),
...
('MedievalYields', 'YIELD_GOLD',       1,-15), -- def. 15
...
-- INDUSTRIAL
('IndustrialYields', 'YIELD_CULTURE',	1, -15),
...
('IndustrialPseudoYields', 'PSEUDOYIELD_CITY_DEFENDING_UNITS', 1, -10),
...
('ModernPseudoYields', 'PSEUDOYIELD_CITY_DEFENDING_UNITS', 1, -5),
...
('ModernPseudoYields', 'PSEUDOYIELD_IMPROVEMENT', 1, 15),
...
('AtomicPseudoYields', 'PSEUDOYIELD_CITY_DEFENDING_UNITS', 1, -10),
