...
('AQUARIUM',NULL,'CONSERVATION',355,'WATER_ENTERTAINMENT_COMPLEX',3,'GENERIC'),
('AQUATICS_CENTER',NULL,'SOCIAL_MEDIA',660,'WATER_ENTERTAINMENT_COMPLEX',4,'GENERIC'),
('FERRIS_WHEEL',NULL,'CONSERVATION',175,'WATER_ENTERTAINMENT_COMPLEX',1,'GENERIC'),
('FOOD_MARKET','PLASTICS',NULL,370,'NEIGHBORHOOD',2,'GENERIC'),
('ORDU','CONSTRUCTION',NULL,70,'ENCAMPMENT',1,'CONQUEST'),
('SHOPPING_MALL',NULL,'CULTURAL_HERITAGE',465,'NEIGHBORHOOD',2,'CULTURE'),
('TSIKHE','BALLISTICS',NULL,130,'CITY_CENTER',1,'GENERIC'); -- exception
