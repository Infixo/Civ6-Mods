...
('AIRPORT','TELECOMMUNICATIONS',NULL,450,'AERODROME',2,'CONQUEST'),
...
('BARRACKS','IRON_WORKING',NULL,40,'ENCAMPMENT',1,'CONQUEST'),
...
('ELECTRONICS_FACTORY','STEAM_POWER',NULL,265,'INDUSTRIAL_ZONE',2,'GENERIC'),
('FACTORY','STEAM_POWER',NULL,265,'INDUSTRIAL_ZONE',2,'GENERIC'),
...
('LIGHTHOUSE','SHIPBUILDING',NULL,50,'HARBOR',1,'GENERIC'),
('MADRASA',NULL,'DIVINE_RIGHT',165,'CAMPUS',2,'TECHNOLOGY'),
...
('POWER_PLANT','COMPUTERS',NULL,655,'INDUSTRIAL_ZONE',3,'GENERIC'),
('RESEARCH_LAB','NUCLEAR_FISSION',NULL,655,'CAMPUS',3,'TECHNOLOGY'),
...
('SHRINE','CELESTIAL_NAVIGATION',NULL,30,'HOLY_SITE',1,'RELIGIOUS'),
('STABLE','CONSTRUCTION',NULL,50,'ENCAMPMENT',1,'CONQUEST'),
...
('BUILDING_ARENA_UPGRADE', 'YIELD_CULTURE', 1),
('BUILDING_ARMORY_UPGRADE', 'YIELD_CULTURE', 1),
('BUILDING_ARMORY_UPGRADE', 'YIELD_PRODUCTION', 1),
...
('BUILDING_GURDWARA_UPGRADE', 'YIELD_CULTURE', 2),
('BUILDING_GURDWARA_UPGRADE', 'YIELD_FAITH', 1),
('BUILDING_GURDWARA_UPGRADE', 'YIELD_FOOD', 1),
('BUILDING_HANGAR_UPGRADE', 'YIELD_PRODUCTION', 1),
('BUILDING_LIBRARY_UPGRADE', 'YIELD_SCIENCE', 1),
('BUILDING_LIGHTHOUSE_UPGRADE', 'YIELD_FOOD', 2),
('BUILDING_MADRASA_UPGRADE', 'YIELD_SCIENCE', 2),
('BUILDING_MARKET_UPGRADE', 'YIELD_GOLD', 2),
('BUILDING_MEETING_HOUSE_UPGRADE', 'YIELD_FAITH', 1),
('BUILDING_MEETING_HOUSE_UPGRADE', 'YIELD_PRODUCTION', 1),
('BUILDING_MEETING_HOUSE_UPGRADE', 'YIELD_SCIENCE', 2),
...
('BUILDING_MUSEUM_ART_UPGRADE', 'YIELD_CULTURE', 1),
('BUILDING_MUSEUM_ARTIFACT_UPGRADE', 'YIELD_CULTURE', 1),
('BUILDING_PAGODA_UPGRADE', 'YIELD_CULTURE', 2),
('BUILDING_PAGODA_UPGRADE', 'YIELD_FAITH', 2),
('BUILDING_PALACE_UPGRADE', 'YIELD_GOLD', 3),
...
('BUILDING_SEAPORT_UPGRADE', 'YIELD_PRODUCTION', 2),
('BUILDING_SHIPYARD_UPGRADE', 'YIELD_FOOD', 1),
...
('BUILDING_STOCK_EXCHANGE_UPGRADE', 'YIELD_GOLD', 4),
...
('BUILDING_WAT_UPGRADE', 'YIELD_FAITH', 1),
('BUILDING_WAT_UPGRADE', 'YIELD_PRODUCTION', 2),
