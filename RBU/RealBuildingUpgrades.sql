...
('AIRPORT','TELECOMMUNICATIONS',NULL,450,'AERODROME',4,'CONQUEST'),
...
('BROADCAST_CENTER','COMPUTERS',NULL,720,'THEATER',4,'CULTURE'),
...
('FILM_STUDIO','COMPUTERS',NULL,720,'THEATER',4,'CULTURE'),
...
('MILITARY_ACADEMY','RIFLING',NULL,490,'ENCAMPMENT',4,'CONQUEST'),
('MONUMENT','WRITING',NULL,30,'CITY_CENTER',1,'CULTURE'),
--('MOSQUE',NULL,'REFORMED_CHURCH',140,'HOLY_SITE',0,NULL),
('MUSEUM_ART',NULL,'THE_ENLIGHTENMENT',215,'THEATER',0,'CULTURE'),
('MUSEUM_ARTIFACT',NULL,'THE_ENLIGHTENMENT',215,'THEATER',0,'CULTURE'),
...
UPDATE GlobalParameters SET Value = '20' WHERE Name = 'SCIENCE_PERCENTAGE_YIELD_PER_POP';
