...
-- +2 Food from RESOURCE_OLIVES, RESOURCE_SUGAR, RESOURCE_TEA, RESOURCE_WINE
INSERT INTO BuildingModifiers (BuildingType, ModifierId) VALUES
...
('RESOURCES_FOR_GRANARY_UPGRADE', 'REQUIRES_OLIVES_IN_PLOT'),
('RESOURCES_FOR_GRANARY_UPGRADE', 'REQUIRES_SUGAR_IN_PLOT'),
('RESOURCES_FOR_GRANARY_UPGRADE', 'REQUIRES_TEA_IN_PLOT'),
...
-- +2 Food from RESOURCE_BANANAS, RESOURCE_CITRUS, RESOURCE_COCOA, RESOURCE_SPICES
INSERT INTO BuildingModifiers (BuildingType, ModifierId) VALUES
('BUILDING_ZOO_UPGRADE', 'ZOO_UPGRADE_ADD_RESOURCE_FOOD');

INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('ZOO_UPGRADE_ADD_RESOURCE_FOOD', 'MODIFIER_CITY_PLOT_YIELDS_ADJUST_PLOT_YIELD', 0, 0, NULL, 'RESOURCES_FOR_ZOO_UPGRADE');

INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('ZOO_UPGRADE_ADD_RESOURCE_FOOD', 'YieldType', 'YIELD_FOOD'),
('ZOO_UPGRADE_ADD_RESOURCE_FOOD', 'Amount',    '2');

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
('RESOURCES_FOR_ZOO_UPGRADE', 'REQUIREMENTSET_TEST_ANY');

INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
('RESOURCES_FOR_ZOO_UPGRADE', 'REQUIRES_BANANAS_IN_PLOT'),
('RESOURCES_FOR_ZOO_UPGRADE', 'REQUIRES_CITRUS_IN_PLOT'),
('RESOURCES_FOR_ZOO_UPGRADE', 'REQUIRES_COCOA_IN_PLOT'),
('RESOURCES_FOR_ZOO_UPGRADE', 'REQUIRES_SPICES_IN_PLOT');
