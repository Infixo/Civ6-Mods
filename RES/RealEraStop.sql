...
VALUES
	-- Classical V1.6
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_MILITARY_TRAINING'),
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_DEFENSIVE_TACTICS'),
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_RECORDED_HISTORY'),
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_THEOLOGY'),
	-- Medieval
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_MERCENARIES'),
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_MEDIEVAL_FAIRES'),
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_GUILDS'),
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_DIVINE_RIGHT'),
	-- Renaissance
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_MERCANTILISM'),
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_THE_ENLIGHTENMENT'),
	-- Industrial
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_NATURAL_HISTORY'),
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_URBANIZATION'),
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_SCORCHED_EARTH'),
	-- Modern
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_CONSERVATION'),
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_NUCLEAR_PROGRAM'),
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_CAPITALISM'),
--	('CIVIC_FUTURE_SOCIETY', 'CIVIC_SUFFRAGE'),
--	('CIVIC_FUTURE_SOCIETY', 'CIVIC_TOTALITARIANISM'),
--	('CIVIC_FUTURE_SOCIETY', 'CIVIC_CLASS_STRUGGLE'),
	-- Atomic
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_CULTURAL_HERITAGE'),
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_RAPID_DEPLOYMENT'),
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_SPACE_RACE'),
	('CIVIC_FUTURE_SOCIETY', 'CIVIC_PROFESSIONAL_SPORTS');
