print("Loading Serialize.lua from Real Era Tracker version "..(GlobalParameters.RET_VERSION_MAJOR and GlobalParameters.RET_VERSION_MAJOR or "0").."."..(GlobalParameters.RET_VERSION_MINOR and GlobalParameters.RET_VERSION_MINOR or "0"));
--===========================================================================
...
print("OK loaded Serialize.lua from Real Era Tracker");